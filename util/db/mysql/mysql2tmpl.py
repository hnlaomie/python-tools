...
def print_html_doc(data):
    ...
    output = j2_env.get_template('template/temp.tmpl').render(data)
    print(output)
...
if __name__ == '__main__':
    ...
    server = "mysql+mysqlconnector://bidev:bidev@localhost:3306/dw_yingguang?charset=utf8"
    ...
    for table_name in smeta.tables.keys():
        ...
        if str(tableInfo.name).endswith("_201611"):
            print_html_doc(data)
